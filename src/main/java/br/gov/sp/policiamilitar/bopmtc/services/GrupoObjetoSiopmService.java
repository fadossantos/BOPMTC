...
import br.gov.sp.policiamilitar.bopmtc.model.GrupoObjetoSiopm;

@Service
public class GrupoObjetoSiopmService {

	  public Iterable<GrupoObjetoSiopm> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/grupoObjetoSiopm/listar";
			...
			GrupoObjetoSiopm[] arrayRetorno = restTemplate.getForObject( uri, GrupoObjetoSiopm[].class);
