...
public class TipoVeiculoService {
	  ...
	  public Iterable<TipoVeiculo> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/tipoVeiculo/listar";
			...
			TipoVeiculo[] arrayRetorno = restTemplate.getForObject( uri, TipoVeiculo[].class);
