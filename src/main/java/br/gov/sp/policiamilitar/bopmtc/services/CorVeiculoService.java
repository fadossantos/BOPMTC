...
import br.gov.sp.policiamilitar.bopmtc.model.CorVeiculo;

@Service
public class CorVeiculoService {

	  public Iterable<CorVeiculo> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/corVeiculo/listar";
			...
			CorVeiculo[] arrayRetorno = restTemplate.getForObject( uri, CorVeiculo[].class);
