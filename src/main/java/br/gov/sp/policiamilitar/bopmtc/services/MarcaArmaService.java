...
import br.gov.sp.policiamilitar.bopmtc.model.MarcaArma;

@Service
public class MarcaArmaService {

	  public Iterable<MarcaArma> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/marcaArma/listar";
			...
			MarcaArma[] arrayRetorno = restTemplate.getForObject( uri, MarcaArma[].class);
