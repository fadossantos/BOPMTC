...
import br.gov.sp.policiamilitar.bopmtc.model.GrupoTipoVeiculo;

@Service
public class GrupoTipoVeiculoService {

	  public Iterable<GrupoTipoVeiculo> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/grupoTipoVeiculo/listar";
			...
			GrupoTipoVeiculo[] arrayRetorno = restTemplate.getForObject( uri, GrupoTipoVeiculo[].class);
