...
import br.gov.sp.policiamilitar.bopmtc.model.MarcaVeiculo;

@Service
public class MarcaVeiculoService {

	  public Iterable<MarcaVeiculo> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/marcaVeiculo/listar";
			...
			MarcaVeiculo[] arrayRetorno = restTemplate.getForObject( uri, MarcaVeiculo[].class);
