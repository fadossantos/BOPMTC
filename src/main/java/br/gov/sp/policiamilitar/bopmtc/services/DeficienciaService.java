...
import br.gov.sp.policiamilitar.bopmtc.model.Deficiencia;

@Service
public class DeficienciaService {

	  public Iterable<Deficiencia> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/deficiencia/listar";
			...
			Deficiencia[] arrayRetorno = restTemplate.getForObject( uri, Deficiencia[].class);
