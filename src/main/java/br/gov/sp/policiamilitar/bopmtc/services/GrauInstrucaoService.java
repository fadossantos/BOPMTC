...
import br.gov.sp.policiamilitar.bopmtc.model.GrauInstrucao;

@Service
public class GrauInstrucaoService {

	  public Iterable<GrauInstrucao> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/grauInstrucao/listar";
			...
			GrauInstrucao[] arrayRetorno = restTemplate.getForObject( uri, GrauInstrucao[].class);
