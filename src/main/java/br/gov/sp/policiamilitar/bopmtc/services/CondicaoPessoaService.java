...
import br.gov.sp.policiamilitar.bopmtc.model.CondicaoPessoa;

@Service
public class CondicaoPessoaService {

	  public Iterable<CondicaoPessoa> findAll(HttpSession session) {
		    final String uri = "http://homologa.policiamilitar.sp.gov.br/BOPMTC.ModuloExterno/api/externo/dominio/condicaoPessoa/listar";
			...
			CondicaoPessoa[] arrayRetorno = restTemplate.getForObject( uri, CondicaoPessoa[].class);
